...
const Yep = () => {
  return (
    <Container>
      ...
      <div className="h-[120px] bg-yep_banner bg-cover bg-custom md:h-[325px] lg:bg-cover lg:bg-left" style={{ borderRadius: '8px', margin: '32px 0px' }}/>
      ...
      <div className="yep_content" style={{color: 'white'}}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-evenly' }}>
          <a href="https://unstop.com/workshops-webinars/young-entrepreneur-program-yep-2024-eximius-2024-iim-bangalores-entrepreneurship-summit-iim-bangalore-949716?lb=z3lV7Wf" target="_blank" class="btn btn-lg">Register Now</a>
        </div>
        <p><strong>&nbsp;</strong></p>
